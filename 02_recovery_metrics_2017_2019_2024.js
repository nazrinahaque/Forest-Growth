// ============================================================
// NDVI RECOVERY METRICS — 2017, 2019, 2024
// Author: Nazrina Haque
// Description: Builds four vegetation recovery metrics using
//              three NDVI snapshots across pre-hurricane
//              baseline (2017), post-damage (2019), and
//              recovery (2024) periods
//              Exports regression-ready CSV to Google Drive
//
// Recovery Metrics:
//   damage       = NDVI 2019 - NDVI 2017 (storm damage)
//   recovery     = NDVI 2024 - NDVI 2019 (short recovery)
//   full_recovery= NDVI 2024 - NDVI 2017 (full recovery)
//   pct_recovery = recovery / (2017 - 2019) (% recovered)
// ============================================================
...
// ============================================================
// 3. ANNUAL NDVI COMPOSITE FUNCTION
// ============================================================
...
// ============================================================
// 4. BUILD NDVI COMPOSITES
// 2017 = pre-hurricane baseline
// 2019 = post-Michael damage
// 2024 = recovery / development
// ============================================================
...
// Percent recovery = how much of the damage has been regained
...
Map.addLayer(ndvi2017,     ndviVis, 'NDVI 2017 (Baseline)');
Map.addLayer(ndvi2019,     ndviVis, 'NDVI 2019 (Post-damage)');
Map.addLayer(ndvi2024,     ndviVis, 'NDVI 2024 (Recovery)');
Map.addLayer(fullRecovery, diffVis, 'Full Recovery 2024-2017');


// ============================================================
// 7. LOAD CHEAP SALES PARCEL POINTS
// ============================================================
...
// ============================================================
// 9. STACK ALL METRICS INTO ONE IMAGE
// ============================================================
